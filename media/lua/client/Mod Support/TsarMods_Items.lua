...
TweakItem("Base.ATA2ItemContainer","DisplayCategory","Container");
TweakItem("Base.ATABullbarPoliceItem1","DisplayCategory","Mechanics");
TweakItem("Base.ATABullbar1Item","DisplayCategory","Mechanics");
TweakItem("Base.ATABullbar2Item","DisplayCategory","Mechanics");
TweakItem("Base.ATAFendersWideItem","DisplayCategory","Mechanics");
TweakItem("Base.ATASkirtsSideItem","DisplayCategory","Mechanics");
TweakItem("Base.ATASpoilerFrontItem","DisplayCategory","Mechanics");
TweakItem("Base.ATASpoilerRear1Item","DisplayCategory","Mechanics");
TweakItem("Base.ATASpoilerRear2Item","DisplayCategory","Mechanics");
TweakItem("Base.ATARoofLightItem","DisplayCategory","Mechanics");
TweakItem("Base.ATASleepingBag","DisplayCategory","Mechanics");
TweakItem("Base.ATASpoilerFront","DisplayCategory","Mechanics");
end
